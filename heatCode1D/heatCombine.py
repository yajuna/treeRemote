...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 27 14:12:27 2021

This code combines the main code heat1dK.py with new boundary term from Michael
and source term from Selina

The bdry term and source term are of length equal to timeSteps
